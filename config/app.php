...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Maintenance Mode White-listed IP's
    |--------------------------------------------------------------------------
    |
    | Allow access for the white-listed IP's even if application is in Maintenance Mode
    |
    */
    ...
    */
    ...
    'providers' => [
        ...
        App\Providers\PasswordResetServiceProvider::class, // Illuminate\Auth\Passwords\PasswordResetServiceProvider::class,
