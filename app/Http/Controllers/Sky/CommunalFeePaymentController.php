...
use App\Http\Requests\Sky\CommunalFeePaymentRequest;

class CommunalFeePaymentController extends Controller {

    protected $route = 'communal-fees-payments';
            ...
            $this->route => [
                ...
                'joins' => [
                    [
                        ...
                        'constrain' => '=',
                        'foreignColumn' => 'communal_fees_payments.rental_company_id',
                    ...
                    [
                        ...
                        'constrain' => '=',
                        'foreignColumn' => 'communal_fees_payments.owner_id',
                    ],
                ],
                'selectors' => ['communal_fees_payments.comments', 'rental_company_translations.name as company'],
                'columns' => [
                    [
                        'selector' => 'communal_fees_payments.id',
                        'id' => 'id',
                        'checkbox' => true,
                        'order' => false,
                        'class' => 'text-center',
                    ...
                    [
                        'selector' => 'communal_fees_payments.paid_at',
                        'id' => 'paid_at',
                        ...
                        'join' => [
                            ...
                            'constrain' => '=',
                            'foreignColumn' => 'communal_fees_payments.year_id',
                        ],
                        'link' => [
                            'selector' => ['years.year', 'communal_fees_payments.apartment_id'],
                            'icon' => 'folder-open',
                            'route' => 'communal-fees-payment-documents',
                            'routeParametersPrepend' => ['apartment_id' => 'communal-fees', 'year' => '', 'id' => ''],
                        ],
                    ],
                    [
                        'selector' => 'communal_fees_payments.amount',
                        'id' => 'amount',
                    ...
                    [
                        ...
                        'join' => [
                            ...
                            'constrain' => '=',
                            'foreignColumn' => 'communal_fees_payments.payment_method_id',
    ...
    public function index(DataTable $datatable, Request $request, $apartment = null, $communalFeesSlug = null, $year = null)
    {
        $breadcrumbs = [];
        ...
        $datatable->setup(CommunalFeePayment::where('apartment_id', $apartment->id)->where('year_id', $year->id), $this->route, $this->datatables[$this->route]);
    ...
    public function save(DataTable $datatable, CommunalFeePaymentRequest $request)
    {
        ...
        $payment = CommunalFeePayment::create($request->all());
        ...
        if ($payment->id) {
            ...
            $datatable->setup(CommunalFeePayment::where('apartment_id', $apartment->id)->where('year_id', $year->id), $request->input('table'), $this->datatables[$request->input('table')], true);
    ...
    public function destroy(DataTable $datatable, CommunalFeePayment $payment, Request $request)
    {
        $apartment = Apartment::findOrFail([$request->input('apartment')])->first();
        $year = Year::findOrFail([$request->input('year')])->first();
    ...
    {
        $payment = CommunalFeePayment::findOrFail($id);
    ...
    public function update(DataTable $datatable, CommunalFeePaymentRequest $request)
    {
        $payment = CommunalFeePayment::findOrFail($request->input('id'))->first();
        ...
        if ($payment->update($request->all())) {
            ...
            $datatable->setup(CommunalFeePayment::where('apartment_id', $payment->apartment_id)->where('year_id', $payment->year_id), $request->input('table'), $this->datatables[$request->input('table')], true);
            $datatable->setOption('url', \Locales::route($this->route, true));
            $datatables = $datatable->getTables();
