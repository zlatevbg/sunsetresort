...
<div class="magnific-popup">
    ...
    @if (isset($payment))
    {!! Form::model($payment, ['method' => 'put', 'url' => \Locales::route('mm-fees-payments/update'), 'id' => 'edit-payment-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @else
    {!! Form::open(['url' => \Locales::route('mm-fees-payments/save'), 'id' => 'add-payment-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
