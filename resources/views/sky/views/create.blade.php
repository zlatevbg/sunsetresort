...
<div class="magnific-popup">
    ...
    <div class="form-group">
        ...
        {!! Form::text('name_translations[' . $locale->locale . ']', (isset($view) && $view->hasTranslation($locale->locale)) ? $view->translate($locale->locale)->name : null, ['id' => 'input-name-' . $locale->locale, 'class' => 'form-control', 'placeholder' => trans(\Locales::getNamespace() . '/forms.namePlaceholder') . ' - ' . $locale->name]) !!}
    </div>
    @endforeach
