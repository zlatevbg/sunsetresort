...
<div class="magnific-popup">
    ...
    {!! Form::open(['method' => 'delete', 'url' => \Locales::route('apartment-maintenance-issues/destroy'), 'id' => 'delete-maintenance-issue-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
