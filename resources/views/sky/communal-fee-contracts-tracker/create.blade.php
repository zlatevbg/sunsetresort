...
<div class="magnific-popup">
    ...
    @if (isset($communalFeeContract))
    {!! Form::model($communalFeeContract, ['method' => 'put', 'url' => \Locales::route('communal-fee-contracts-tracker/update'), 'id' => 'edit-communal-fee-contract-tracker-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @else
    {!! Form::open(['url' => \Locales::route('communal-fee-contracts-tracker/store'), 'id' => 'create-communal-fee-contract-tracker-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @endif
    ...
    <div class="form-group ajax-lock">
        ...
        {!! Form::multiselect('apartment_id', $multiselect['apartments'], ['id' => 'input-apartment_id', 'class' => 'form-control', 'data-ajax-queue' => 'sync', 'data-href' => \Locales::route('communal-fee-contracts-tracker/get-owners')]) !!}
    </div>

    <div class="form-group">
        {!! Form::label('input-owner_id', trans(\Locales::getNamespace() . '/forms.ownerLabel')) !!}
        {!! Form::multiselect('owner_id', $multiselect['owners'], ['id' => 'input-owner_id', 'class' => 'form-control'] + (isset($communalFeeContract) ? [] : ['disabled'])) !!}
    </div>
    ...
    <script>
    @section('script')
        var selectedApartment = {!! isset($communalFeeContract) ? $communalFeeContract->apartment_id : 'null' !!};
        var selectedOwner = {!! isset($communalFeeContract) ? $communalFeeContract->owner_id : 'null' !!};
