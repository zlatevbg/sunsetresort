...
<div class="magnific-popup">
    ...
    @if (isset($recipient))
    {!! Form::model($recipient, ['method' => 'put', 'url' => \Locales::route('recipients/update'), 'id' => 'edit-recipient-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @else
    {!! Form::open(['url' => \Locales::route('recipients/store'), 'id' => 'create-recipient-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @endif
