...
class CreateCommunalFeesPaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('communal_fees_payments', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('communal_fees_payments');
    }
}
